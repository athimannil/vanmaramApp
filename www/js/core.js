        ...
        xmlhttp.onreadystatechange = function(){
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200){
                ...
                for (i=0; i<decodedResp.length; i++){
                    ...
                    resultLi += "<li class='table-view-cell'><a href='result/answer.html' class='navigate-right suggested-word' data-transition='slide-in' ontouchstart='getSearchValue(\""+decodedResp[i]+"\");' data-search-word='"+decodedResp[i]+"'>"+decodedResp[i]+"</a></li>";
                }
